...
[Files]
Source: ..\Seggu.Desktop\bin\Debug\*; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: ..\Seggu.Desktop\bin\Debug\seggu.sqlite; DestDir: "{app}"; Permissions: everyone-full; Flags: ignoreversion 
