...
namespace Seggu.Infrastructure
{
    public static class Bootstrapper
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<ISynchronizationsService, SynchronizationsService>();
            // Daos
            ...
            container.RegisterType<ISynchronizationProcessesDao, SynchronizationProcessesDao>();
