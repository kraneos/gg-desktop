...
namespace Seggu.Desktop.Forms
{
    public partial class Layout : Form
    {
        ...
        private ISynchronizationsService _synchronizationService;

        public Layout( IFeeService feeService, IBankService bankService, IPolicyService policyService, IClientService clientService, ILoginService loginService, ISynchronizationsService synchronizationService)
        {
            InitializeComponent();
        ...
        private void importarRubricaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            
        }

        private void OnSynchronizationTimerClick(object sender, EventArgs e)
        {
            if (this._synchronizationService.IsHappening())
            {
                this.ActualizandoLabel.Visible = true;
                this.ActualizandoPictureBox.Visible = true;
            }
            else
            {
